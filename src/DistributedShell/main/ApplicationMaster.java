...
public class ApplicationMaster {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            LOG.info("Initializing DistributedShell.main.ApplicationMaster");
            ...
            LOG.fatal("Error running DistributedShell.main.ApplicationMaster", t);
            LogManager.shutdown();
    ...
    public boolean init(String[] args) throws ParseException, IOException {
        ...
        Map<String, String> envs = System.getenv();//获取环境系统变量
        ...
        // Creating the Timeline DistributedShell.main.Client
    ...
    private void printUsage(Options opts) {
        new HelpFormatter().printHelp("DistributedShell.main.ApplicationMaster", opts);
    }
    ...
    public void run() throws YarnException, IOException {
        LOG.info("Starting DistributedShell.main.ApplicationMaster");
